 ...
 *
 * SVN $Revision: 5191 $
 * SVN $Date: 2013-03-18 19:09:19 +0000 (Mon, 18 Mar 2013) $
 */
/*=========================================================================*//**
...
/***************************************************************************//**
  MSS UART Interrupts
  These defines specify the interrupt masks to enable and disable MSS UART 
...
typedef enum {
    ASYNC_MODE               = 0,
    SYNC_SLAVE_POS_EDGE_CLK  = 1,
    SYNC_SLAVE_NEG_EDGE_CLK  = 2,
    SYNC_MASTER_POS_EDGE_CLK = 3,
    SYNC_MASTER_NEG_EDGE_CLK = 4,
    INVALID_SYNC_MODE        = 5
...
/***************************************************************************//**
  ...
  @code
    ...
    MSS_UART_set_usart_mode(&g_mss_uart0, SYNC_MASTER_POS_EDGE_CLK);
  @endcode
 */
void 
