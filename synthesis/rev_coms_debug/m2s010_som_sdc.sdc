# Written by Synplify Pro version map201609actrcp1, Build 005R. Synopsys Run ID: sid1524573505 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {m2s010_som_sb|BIBUF_1_Y_inferred_clock} [get_pins {m2s010_som_sb_0/BIBUF_1:Y}] 
...
set Inferred_clkgroup_7 [list m2s010_som|I2C_0_SCL_F2M]
set Inferred_clkgroup_0 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL0_net_inferred_clock]
set Inferred_clkgroup_1 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL1_net_inferred_clock]
set Inferred_clkgroup_12 [list m2s010_som_sb|BIBUF_1_Y_inferred_clock]
...
set Inferred_clkgroup_4 [list m2s010_som_sb_MSS|MAC_MII_MDC_inferred_clock]
...
set Inferred_clkgroup_11 [list jtag_interface_x|b9_nv_oQwfYF]
set identify_jtag_group1 [list ident_coreinst.comm_block_INST.dr2_tck]
set Inferred_clkgroup_10 [list jtag_interface_x|b10_8Kz_rKlrtX]
set Inferred_clkgroup_9 [list jtag_interface_x|identify_clk_int_inferred_clock]
