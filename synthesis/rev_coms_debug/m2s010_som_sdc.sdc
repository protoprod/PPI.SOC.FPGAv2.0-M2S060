# Written by Synplify Pro version map201609actrcp1, Build 005R. Synopsys Run ID: sid1529953685 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {m2s010_som|HOST_DETn} [get_ports {HOST_DETn}] 
...
set Inferred_clkgroup_5 [list m2s010_som|HOST_DETn]
set Inferred_clkgroup_8 [list m2s010_som|I2C_0_SCL_F2M]
...
set Inferred_clkgroup_13 [list m2s010_som_sb|BIBUF_1_Y_inferred_clock]
set Inferred_clkgroup_6 [list m2s010_som_sb_CCC_0_FCCC|GL0_net_inferred_clock]
set Inferred_clkgroup_7 [list m2s010_som_sb_MSS|FIC_2_APB_M_PCLK_inferred_clock]
