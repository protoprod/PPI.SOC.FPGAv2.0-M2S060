# Written by Synplify Pro version map201609actrcp1, Build 005R. Synopsys Run ID: sid1516816270 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {m2s010_som_CommsFPGA_CCC_0_FCCC|GL2_net_inferred_clock} [get_pins {CommsFPGA_CCC_0/CCC_INST:GL2}] 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {Phy_Mux|F_MDC_inferred_clock} [get_pins {CommsFPGA_top_0/MANCHESTER_DECODER2_INST/CLOCK_DOMAIN_BUFFER_INST/CLOCK_DOMAIN_BUFFER_0/N_40_0_i:Y}] 
...
set Inferred_clkgroup_4 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL0_net_inferred_clock]
set Inferred_clkgroup_0 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL2_net_inferred_clock]
set Inferred_clkgroup_1 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL1_net_inferred_clock]
set Inferred_clkgroup_5 [list m2s010_som_sb_CCC_0_FCCC|GL0_net_inferred_clock]
set Inferred_clkgroup_6 [list m2s010_som_sb_MSS|FIC_2_APB_M_PCLK_inferred_clock]
set Inferred_clkgroup_3 [list CommsFPGA_top|ClkDivider_inferred_clock\[1\]]
set Inferred_clkgroup_2 [list CommsFPGA_top|BIT_CLK_inferred_clock]
set Inferred_clkgroup_11 [list Phy_Mux|F_MDC_inferred_clock]
set Inferred_clkgroup_10 [list jtag_interface_x|b9_nv_oQwfYF]
set identify_jtag_group1 [list ident_coreinst.comm_block_INST.dr2_tck]
set Inferred_clkgroup_9 [list jtag_interface_x|b10_8Kz_rKlrtX]
set Inferred_clkgroup_8 [list jtag_interface_x|identify_clk_int_inferred_clock]
