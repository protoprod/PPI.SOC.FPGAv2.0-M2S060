# Written by Synplify Pro version map201609actrcp1, Build 005R. Synopsys Run ID: sid1520433362 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {m2s010_som|MII_DBG_PHYn} [get_ports {MII_DBG_PHYn}] 
...
set Inferred_clkgroup_2 [list m2s010_som|I2C_0_SCL_F2M]
set Inferred_clkgroup_8 [list m2s010_som|MII_DBG_PHYn]
set Inferred_clkgroup_9 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL0_net_inferred_clock]
set Inferred_clkgroup_4 [list m2s010_som_CommsFPGA_CCC_0_FCCC|GL1_net_inferred_clock]
set Inferred_clkgroup_6 [list CommsFPGA_top|ClkDivider_inferred_clock\[1\]]
set Inferred_clkgroup_5 [list CommsFPGA_top|BIT_CLK_inferred_clock]
