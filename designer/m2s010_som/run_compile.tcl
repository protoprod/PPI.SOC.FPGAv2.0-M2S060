...
set_defvar -name {PA4_GB_MAX_RCLKINT_INSERTION} -value {8}
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\gcallsen\Documents\GitHubBF\PPI.SOC.FPGAv2.0-M2S060\synthesis\rev_coms_debug\m2s010_som.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
