...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\work\IRail\PPI.IRail.SoC.FPGA\synthesis\AFE_RX_SM.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\work\IRail\PPI.IRail.SoC.FPGA\constraint\io\m2s010_som.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\work\IRail\PPI.IRail.SoC.FPGA\constraint\fp\m2s010_som.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M6000 \
    -pkg fcs325 \
    -pdc_file {C:\work\IRail\PPI.IRail.SoC.FPGA\constraint\io\m2s010_som.io.pdc} \
    -pdc_file {C:\work\IRail\PPI.IRail.SoC.FPGA\constraint\fp\m2s010_som.fp.pdc} \
    -merge_pdc 0
