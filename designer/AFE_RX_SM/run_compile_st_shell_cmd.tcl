...
save
set has_violations {C:\work\IRail\PPI.IRail.SoC.FPGA\designer\AFE_RX_SM\AFE_RX_SM_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\work\IRail\PPI.IRail.SoC.FPGA\designer\AFE_RX_SM\AFE_RX_SM_combinational_loops.xml}
if { [catch "file delete -force -- {C:\work\IRail\PPI.IRail.SoC.FPGA\designer\AFE_RX_SM\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\work\IRail\PPI.IRail.SoC.FPGA\designer\AFE_RX_SM\pinslacks.txt}
